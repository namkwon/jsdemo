...
(function() {
  ...
  function getItemDetail(itemId){
    url ="https://api.themoviedb.org/3/movie/";
      ...
      $itemRow2.append($('<h5>Trailer</h5>'));
      $itemRow2.append($('<div class="trailer embed-responsive">'));
      getTrailer(itemId);
    ...
    $.ajax({
      ...
      data.results.forEach(function(trailer) {
        if(trailer.type == "Trailer" && trailer.site == "YouTube"){
          $video = $('<div class="col-sm-12 col-md-12 col-lg-6">');
          $video.append($('<iframe>').attr('class','embed-responsive-item').attr('src', 'https://www.youtube.com/embed/'+trailer.key));
