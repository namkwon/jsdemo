...
(function() {
  ...
  function makeItems(){
    ...
    var suburl = "?sort_by=popularity.desc";
      ...
      data.results.forEach(function(movie) {
    		var $itemContainer = $('<div class="col-sm-3 col-md-2"></div>');
  ...
  function getItemDetail(itemId){
    url ="https://api.themoviedb.org/3/movie/";
      ...
      $itemLeft = $('<div class="col-sm-3 col-md-3">');
      ...
      $itemRight= $('<div class="col-sm-9 col-md-9">');
  ...
  function getCasts(itemId){
    ...
    $.ajax({
      ...
      data.cast.forEach(function(cast,index) {
        if(index < 5){
          $star = $('<div class="col-sm-2 col-md-2">');
